The extension integrates your Magento 2 store with the **[mPAY24](https://www.mpay24.com)** payment service (Austria, Germany).

## How to buy
The extension is not released yet, so there is no way to buy it just now.  
The extension will be released before 2017-05-11.   
...
### 2. Self-installation
```
composer require mage2pro/mpay24:*
bin/magento setup:upgrade
rm -rf pub/static/* && bin/magento setup:static-content:deploy <locale, e.g.: de_AT>
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/mpay24).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/mpay24).
